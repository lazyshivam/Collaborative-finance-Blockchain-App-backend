...
const { AdminModel, AdminStaff } = require('../../models');
...
const resetPassword = async (resetPasswordToken, newPassword) => {
    try {
        ...
        var user = await AdminStaff.findOne({ _id: resetPasswordTokenDoc.user });
        if (user == null) {
            ...
            await adminStaffService.updateAdminStaffUserById(user._id, { password: newPassword });
